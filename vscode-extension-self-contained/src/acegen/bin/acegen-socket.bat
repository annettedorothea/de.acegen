...
@rem Add default JVM options here. You can also use JAVA_OPTS and ACEGEN_SOCKET_OPTS to pass JVM options to this script.
...
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %ACEGEN_SOCKET_OPTS%  -classpath "%CLASSPATH%" de.acegen.ide.RunServer %CMD_LINE_ARGS%
...
:fail
rem Set variable ACEGEN_SOCKET_EXIT_CONSOLE if you need the _script_ return code instead of
rem the _cmd.exe /c_ return code!
if  not "" == "%ACEGEN_SOCKET_EXIT_CONSOLE%" exit 1
exit /b 1
