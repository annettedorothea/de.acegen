...
public class AceGenGrammarAccess extends AbstractGrammarElementFinder {
	...
	public class ScenarioElements extends AbstractParserRuleElementFinder {
		...
		private final Assignment cScenariosAssignment_1_1 = (Assignment)cGroup_1.eContents().get(1);
		private final CrossReference cScenariosScenarioCrossReference_1_1_0 = (CrossReference)cScenariosAssignment_1_1.eContents().get(0);
		private final RuleCall cScenariosScenarioQualifiedNameParserRuleCall_1_1_0_1 = (RuleCall)cScenariosScenarioCrossReference_1_1_0.eContents().get(1);
		...
		//Scenario:
		//	name=ID ('GIVEN' scenarios+=[Scenario|QualifiedName]*)?
		//	'WHEN' whenBlock=WhenBlock
		//	'THEN' thenBlock=ThenBlock;
		@Override public ParserRule getRule() { return rule; }
		
		//name=ID ('GIVEN' scenarios+=[Scenario|QualifiedName]*)? 'WHEN' whenBlock=WhenBlock 'THEN' thenBlock=ThenBlock
		public Group getGroup() { return cGroup; }
		...
		public Assignment getScenariosAssignment_1_1() { return cScenariosAssignment_1_1; }
		
		//[Scenario|QualifiedName]
		public CrossReference getScenariosScenarioCrossReference_1_1_0() { return cScenariosScenarioCrossReference_1_1_0; }
		
		//QualifiedName
		public RuleCall getScenariosScenarioQualifiedNameParserRuleCall_1_1_0_1() { return cScenariosScenarioQualifiedNameParserRuleCall_1_1_0_1; }
	...
	public class ThenBlockElements extends AbstractParserRuleElementFinder {
		...
		private final Assignment cResponseAssignment_1_1 = (Assignment)cGroup_1.eContents().get(1);
		private final RuleCall cResponseDataDefinitionParserRuleCall_1_1_0 = (RuleCall)cResponseAssignment_1_1.eContents().get(0);
		
		//ThenBlock:
		//	statusCode=INT ('response' response=DataDefinition)?;
		@Override public ParserRule getRule() { return rule; }
		...
		public Assignment getResponseAssignment_1_1() { return cResponseAssignment_1_1; }
		
		//DataDefinition
		public RuleCall getResponseDataDefinitionParserRuleCall_1_1_0() { return cResponseDataDefinitionParserRuleCall_1_1_0; }
	}
