...
public interface AceGenPackage extends EPackage
{
  ...
  /**
   * Returns the meta object for the reference list '{@link de.acegen.aceGen.Scenario#getScenarios <em>Scenarios</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the reference list '<em>Scenarios</em>'.
   * @see de.acegen.aceGen.Scenario#getScenarios()
   * @see #getScenario()
   * @generated
   */
  EReference getScenario_Scenarios();
  ...
  interface Literals
  {
     ...
     * @generated
     */
    EReference SCENARIO__SCENARIOS = eINSTANCE.getScenario_Scenarios();
