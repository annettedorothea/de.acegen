 ...
 *   <li>{@link de.acegen.aceGen.SingleClientAttribute#getName <em>Name</em>}</li>
...
public interface SingleClientAttribute extends ClientAttribute
{
   ...
   * @see #setName(String)
   * @see de.acegen.aceGen.AceGenPackage#getSingleClientAttribute_Name()
   * @model
   * @generated
   */
  String getName();
  ...
  /**
   * Sets the value of the '{@link de.acegen.aceGen.SingleClientAttribute#getName <em>Name</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
