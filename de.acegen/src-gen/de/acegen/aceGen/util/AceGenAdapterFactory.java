...
public class AceGenAdapterFactory extends AdapterFactoryImpl
{
  ...
  protected AceGenSwitch<Adapter> modelSwitch =
    new AceGenSwitch<Adapter>()
    {
      ...
      @Override
      public Adapter caseCustomVerification(CustomVerification object)
      {
        return createCustomVerificationAdapter();
      }
      @Override
  ...
  /**
   * Creates a new adapter for an object of class '{@link de.acegen.aceGen.UiAction <em>Ui Action</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
  ...
  /**
   * Creates a new adapter for an object of class '{@link de.acegen.aceGen.CustomVerification <em>Custom Verification</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
   ...
   * @generated
   */
  public Adapter createCustomVerificationAdapter()
  {
    return null;
  }
