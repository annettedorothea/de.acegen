 ...
 *   <li>{@link de.acegen.aceGen.impl.SingleClientAttributeImpl#getName <em>Name</em>}</li>
...
public class SingleClientAttributeImpl extends ClientAttributeImpl implements SingleClientAttribute
{
  ...
  public void setName(String newName)
  {
    ...
    name = newName;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AceGenPackage.SINGLE_CLIENT_ATTRIBUTE__NAME, oldName, name));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      ...
      case AceGenPackage.SINGLE_CLIENT_ATTRIBUTE__TYPE:
        return getType();
      case AceGenPackage.SINGLE_CLIENT_ATTRIBUTE__NAME:
        return getName();
