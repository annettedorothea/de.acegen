...
public class AceGenPackageImpl extends EPackageImpl implements AceGenPackage
{
   ...
   * @generated
   */
  private EClass customVerificationEClass = null;
   ...
   */
  @Override
  public EAttribute getHttpClient_Jsx()
  {
   ...
   */
  @Override
  public EReference getHttpClient_Functions()
  {
   ...
   */
  @Override
  public EReference getFunction_StateElement()
  {
   ...
   */
  @Override
  public EReference getHttpClientOutcome_Functions()
  {
  ...
  {
    return (EReference)httpClientOutcomeEClass.getEStructuralFeatures().get(3);
  }
   ...
   */
  @Override
  public EAttribute getClientAttribute_NoComponent()
  {
   ...
   */
  @Override
  public EReference getClientThenBlock_Verifications()
  {
   ...
   */
  @Override
  public EClass getCustomVerification()
  {
    return customVerificationEClass;
  }
   ...
   */
  @Override
  public EAttribute getCustomVerification_FunctionName()
  {
    return (EAttribute)customVerificationEClass.getEStructuralFeatures().get(0);
  }
   ...
   */
  @Override
  public EReference getCustomVerification_StateRef()
  {
    return (EReference)customVerificationEClass.getEStructuralFeatures().get(1);
  }
   ...
   */
  @Override
  public EAttribute getHttpServer_Java()
  {
   ...
   */
  @Override
  public EAttribute getHttpServer_Cs()
  {
   ...
   */
  @Override
  public EAttribute getHttpServer_Dropwizard()
  {
   ...
   */
  @Override
  public EAttribute getHttpServer_Dotnet()
  {
   ...
   */
  @Override
  public EAttribute getHttpServer_JDBI3()
  {
   ...
   */
  @Override
  public EAttribute getHttpServer_EF()
  {
    return (EAttribute)httpServerEClass.getEStructuralFeatures().get(5);
  }
   ...
   */
  @Override
  public EAttribute getHttpServer_Liquibase()
  {
    return (EAttribute)httpServerEClass.getEStructuralFeatures().get(6);
  }
  ...
  {
    return (EAttribute)httpServerEClass.getEStructuralFeatures().get(7);
  }
  ...
  {
    return (EReference)httpServerEClass.getEStructuralFeatures().get(11);
  }
  ...
  {
    return (EReference)httpServerEClass.getEStructuralFeatures().get(12);
  }
  ...
  {
    return (EReference)httpServerEClass.getEStructuralFeatures().get(13);
  }
  ...
  public void createPackageContents()
  {
    ...
    createEReference(httpClientEClass, HTTP_CLIENT__FUNCTIONS);
    ...
    createEReference(functionEClass, FUNCTION__STATE_ELEMENT);
    ...
    createEReference(httpClientOutcomeEClass, HTTP_CLIENT_OUTCOME__FUNCTIONS);
    ...
    createEReference(clientThenBlockEClass, CLIENT_THEN_BLOCK__VERIFICATIONS);
    ...
    customVerificationEClass = createEClass(CUSTOM_VERIFICATION);
    createEAttribute(customVerificationEClass, CUSTOM_VERIFICATION__FUNCTION_NAME);
    createEReference(customVerificationEClass, CUSTOM_VERIFICATION__STATE_REF);
    ...
    createEAttribute(httpServerEClass, HTTP_SERVER__JAVA);
    createEAttribute(httpServerEClass, HTTP_SERVER__CS);
    createEAttribute(httpServerEClass, HTTP_SERVER__DROPWIZARD);
    createEAttribute(httpServerEClass, HTTP_SERVER__DOTNET);
    createEAttribute(httpServerEClass, HTTP_SERVER__JDBI3);
    createEAttribute(httpServerEClass, HTTP_SERVER__EF);
    createEAttribute(httpServerEClass, HTTP_SERVER__LIQUIBASE);
  ...
  public void initializePackageContents()
  {
    ...
    initEReference(getHttpClient_Functions(), this.getFunction(), null, "functions", null, 0, -1, HttpClient.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEReference(getFunction_StateElement(), this.getClientAttribute(), null, "stateElement", null, 0, 1, Function.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEReference(getFromAppStateRef_StateElement(), this.getClientAttribute(), null, "stateElement", null, 0, 1, FromAppStateRef.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEReference(getHttpClientOutcome_Functions(), this.getFunctionCall(), null, "functions", null, 0, -1, HttpClientOutcome.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEReference(getClientThenBlock_Verifications(), this.getCustomVerification(), null, "verifications", null, 0, -1, ClientThenBlock.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEClass(customVerificationEClass, CustomVerification.class, "CustomVerification", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getCustomVerification_FunctionName(), ecorePackage.getEString(), "functionName", null, 0, 1, CustomVerification.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getCustomVerification_StateRef(), this.getClientAttribute(), null, "stateRef", null, 0, 1, CustomVerification.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEAttribute(getHttpServer_Java(), ecorePackage.getEBoolean(), "java", null, 0, 1, HttpServer.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getHttpServer_Cs(), ecorePackage.getEBoolean(), "cs", null, 0, 1, HttpServer.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getHttpServer_Dropwizard(), ecorePackage.getEBoolean(), "dropwizard", null, 0, 1, HttpServer.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getHttpServer_Dotnet(), ecorePackage.getEBoolean(), "dotnet", null, 0, 1, HttpServer.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getHttpServer_JDBI3(), ecorePackage.getEBoolean(), "JDBI3", null, 0, 1, HttpServer.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getHttpServer_EF(), ecorePackage.getEBoolean(), "EF", null, 0, 1, HttpServer.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getHttpServer_Liquibase(), ecorePackage.getEBoolean(), "liquibase", null, 0, 1, HttpServer.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
