 ...
 * </p>
 * <ul>
 *   <li>{@link de.acegen.aceGen.impl.HttpServerViewImpl#isQueued <em>Queued</em>}</li>
...
public class HttpServerViewImpl extends MinimalEObjectImpl.Container implements HttpServerView
{
  ...
  public void setQueued(boolean newQueued)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AceGenPackage.HTTP_SERVER_VIEW__QUEUED, oldQueued, queued));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case AceGenPackage.HTTP_SERVER_VIEW__QUEUED:
        return isQueued();
