 ...
 * </p>
 * <ul>
 *   <li>{@link de.acegen.aceGen.ClientAttribute#isNotNull <em>Not Null</em>}</li>
 *   <li>{@link de.acegen.aceGen.ClientAttribute#isList <em>List</em>}</li>
 *   <li>{@link de.acegen.aceGen.ClientAttribute#getType <em>Type</em>}</li>
 *   <li>{@link de.acegen.aceGen.ClientAttribute#getName <em>Name</em>}</li>
 *   <li>{@link de.acegen.aceGen.ClientAttribute#getModel <em>Model</em>}</li>
 *   <li>{@link de.acegen.aceGen.ClientAttribute#isHash <em>Hash</em>}</li>
...
public interface ClientAttribute extends EObject
{
   ...
   * @see de.acegen.aceGen.AceGenPackage#getClientAttribute_NotNull()
   * @model
   * @generated
   */
  boolean isNotNull();
  ...
  /**
   * Sets the value of the '{@link de.acegen.aceGen.ClientAttribute#isNotNull <em>Not Null</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see #setType(String)
   * @see de.acegen.aceGen.AceGenPackage#getClientAttribute_Type()
   * @model
   * @generated
   */
  String getType();
  ...
  /**
   * Sets the value of the '{@link de.acegen.aceGen.ClientAttribute#getType <em>Type</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see #setModel(Model)
   * @see de.acegen.aceGen.AceGenPackage#getClientAttribute_Model()
   * @model
   * @generated
   */
  Model getModel();
  ...
  /**
   * Sets the value of the '{@link de.acegen.aceGen.ClientAttribute#getModel <em>Model</em>}' reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see #setHash(boolean)
   * @see de.acegen.aceGen.AceGenPackage#getClientAttribute_Hash()
   * @model
   * @generated
   */
  boolean isHash();
  ...
  /**
   * Sets the value of the '{@link de.acegen.aceGen.ClientAttribute#isHash <em>Hash</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
