...
public class ModelTemplate {
  ...
  public CharSequence generateDatabaseHandle() {
    ...
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("this.writeHandle = new PersistenceHandle(jdbi.open());");
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("this.readonlyHandle = new PersistenceHandle(jdbi.open());");
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("if (appConfiguration.getServerConfiguration().writeTimeline()) {");
    _builder.newLine();
    _builder.append("\t\t\t");
    _builder.append("this.timelineHandle = new PersistenceHandle(jdbi.open());");
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("}");
    _builder.newLine();
