...
public class ScenarioTemplate {
  ...
  private CharSequence generateTestDataCreation(final DataDefinition it, final Model model, final String varName, final Integer index) {
    StringConcatenation _builder = new StringConcatenation();
    this.resetVarIndex();
    _builder.newLineIfNotEmpty();
    String _testDataNameWithPackage = this._modelExtension.testDataNameWithPackage(model);
    _builder.append(_testDataNameWithPackage);
    _builder.append(" ");
    _builder.append(varName);
    _builder.append(" = new ");
    String _testDataNameWithPackage_1 = this._modelExtension.testDataNameWithPackage(model);
          ...
          for(final AttributeDefinition attributeDefinition : _attributeDefinitions) {
            {
              ...
              if (_tripleNotEquals_1) {
                String _firstUpper = StringExtensions.toFirstUpper(attributeDefinition.getAttribute().getName());
                String _plus = (varName + _firstUpper);
                CharSequence _generateTestModelCreation = this.generateTestModelCreation(attributeDefinition, _plus, index);
                _builder.append(_generateTestModelCreation);
                _builder.newLineIfNotEmpty();
                _builder.append(varName);
                _builder.append(".");
                Attribute _attribute = attributeDefinition.getAttribute();
                ...
                if (_tripleNotEquals_2) {
                  String _firstUpper_2 = StringExtensions.toFirstUpper(attributeDefinition.getAttribute().getName());
                  String _plus_2 = (varName + _firstUpper_2);
                  String _generateTestModelListCreation = this.generateTestModelListCreation(attributeDefinition, _plus_2, index);
                  _builder.append(_generateTestModelListCreation);
                  _builder.newLineIfNotEmpty();
                  _builder.append(varName);
                  _builder.append(".");
                  Attribute _attribute_1 = attributeDefinition.getAttribute();
                  ...
                  _builder.append(varName);
                  _builder.append(".");
                  String _setterCall_2 = this._attributeExtension.setterCall(attributeDefinition.getAttribute(), this._attributeExtension.testValueFrom(attributeDefinition, index));
                  _builder.append(_setterCall_2);
                  _builder.append(";");
                  _builder.newLineIfNotEmpty();
                }
  ...
  private CharSequence generateTestModelCreation(final AttributeDefinition it, final String varName, final Integer index) {
    StringConcatenation _builder = new StringConcatenation();
    _builder.newLine();
    _builder.append("\t");
    String _testDataNameWithPackage = this._modelExtension.testDataNameWithPackage(it.getAttribute().getModel());
    _builder.append(_testDataNameWithPackage, "\t");
    _builder.append(" ");
    _builder.append(varName, "\t");
    _builder.append(" = new ");
    String _testDataNameWithPackage_1 = this._modelExtension.testDataNameWithPackage(it.getAttribute().getModel());
    _builder.append(_testDataNameWithPackage_1, "\t");
    _builder.append("();");
    _builder.newLineIfNotEmpty();
    {
      ...
      for(final AttributeDefinition attributeDefinition : _attributeDefinitions) {
        {
          ...
          if (_isList) {
            ...
            _builder.newLineIfNotEmpty();
            _builder.append("\t");
            String _generateTestModelListCreation = this.generateTestModelListCreation(attributeDefinition, listVarName, index);
            _builder.append(_generateTestModelListCreation, "\t");
            _builder.newLineIfNotEmpty();
            _builder.append("\t");
            _builder.append(varName, "\t");
            ...
            _builder.append(varName, "\t");
            _builder.append(".");
            String _setterCall_1 = this._attributeExtension.setterCall(attributeDefinition.getAttribute(), this._attributeExtension.testValueFrom(attributeDefinition, index));
            _builder.append(_setterCall_1, "\t");
            _builder.append(";");
            _builder.newLineIfNotEmpty();
          }
  ...
  private String generateTestModelListCreation(final AttributeDefinition it, final String varName, final Integer index) {
    StringConcatenation _builder = new StringConcatenation();
    _builder.newLine();
    {
      ListAttributeDefinitionList _listAttributeDefinitionList = it.getValue().getListAttributeDefinitionList();
      if ((_listAttributeDefinitionList instanceof AttributeDefinitionListForList)) {
        ...
        _builder.newLineIfNotEmpty();
        {
          ...
          for(final AttributeDefinitionList attributeDefinitionList : _attributeDefinitionList) {
            ...
            _builder.newLineIfNotEmpty();
            _builder.append("\t");
            String _testDataNameWithPackage_2 = this._modelExtension.testDataNameWithPackage(it.getAttribute().getModel());
            _builder.append(_testDataNameWithPackage_2, "\t");
            _builder.append(" ");
            _builder.append(itemVarName, "\t");
            _builder.append(" = new ");
            String _testDataNameWithPackage_3 = this._modelExtension.testDataNameWithPackage(it.getAttribute().getModel());
  ...
  private CharSequence generateActionCalls(final HttpServerAce it, final DataDefinition dataDefinition, final Authorization authorization, final HttpServer java, final int index, final boolean returnResponse) {
    StringConcatenation _builder = new StringConcatenation();
    {
      ...
      if (_tripleNotEquals) {
        ...
        CharSequence _generateTestDataCreation = this.generateTestDataCreation(dataDefinition, _model_1, _builder_1.toString(), Integer.valueOf(index));
        _builder.append(_generateTestDataCreation);
        _builder.newLineIfNotEmpty();
      }
    }
    _builder.newLine();
