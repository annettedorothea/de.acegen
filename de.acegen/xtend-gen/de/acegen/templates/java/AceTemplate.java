...
public class AceTemplate {
  ...
  public CharSequence generateNotReplayableDataProvider() {
    ...
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("private static ConcurrentMap<String, DateTime> systemTimeMap = new ConcurrentHashMap<>();");
    _builder.newLine();
    _builder.newLine();
    _builder.append("\t\t");
    ...
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("public static DateTime consumeSystemTime(String uuid) {");
    _builder.newLine();
    _builder.append("\t\t\t");
    _builder.append("DateTime value = systemTimeMap.get(uuid);");
    _builder.newLine();
    _builder.append("\t\t\t");
    ...
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("public static void putSystemTime(String uuid, DateTime systemTime) {");
    _builder.newLine();
    _builder.append("\t\t\t");
  ...
  public CharSequence generateNotReplayableDataProviderResource() {
    StringConcatenation _builder = new StringConcatenation();
    String _copyright = this._commonExtension.copyright();
    _builder.append(_copyright);
    _builder.newLineIfNotEmpty();
  ...
  public CharSequence generateStringToDateTimeConverter() {
    ...
    _builder.newLine();
    _builder.newLine();
    _builder.append("public class StringToDateTimeConverter extends StdConverter<String, DateTime> {");
    _builder.newLine();
    _builder.append("\t");
    _builder.append("@Override");
    _builder.newLine();
    _builder.append("\t");
    _builder.append("public DateTime convert(String value) {");
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("return DateTime.parse(value).withZone(DateTimeZone.UTC);");
    _builder.newLine();
    _builder.append("\t");
    _builder.append("}");
    _builder.newLine();
