...
public class AceTemplate {
  ...
  public CharSequence generateUtils() {
    ...
    _builder.newLine();
    _builder.append("            ");
    _builder.append("const filteredTimeline = ACEController.timeline.filter((item, index) => {");
    _builder.newLine();
    _builder.append("                ");
    ...
    _builder.newLine();
    _builder.append("                ");
    _builder.append("return (!item.appState);");
    _builder.newLine();
    _builder.append("            ");
    _builder.append("});");
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("                ");
    _builder.append("timeline: JSON.stringify(filteredTimeline),");
    _builder.newLine();
    _builder.append("                ");
