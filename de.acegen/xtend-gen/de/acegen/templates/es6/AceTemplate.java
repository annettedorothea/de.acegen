...
public class AceTemplate {
  ...
  public CharSequence generateAppUtilsStub() {
    ...
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("return Utils.settings.clientVersion;");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("}");
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("        ");
    _builder.append("return Utils.settings.aceScenariosApiKey;");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("}");
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("        ");
    _builder.append("return Utils.settings.aceScenariosBaseUrl;");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("}");
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("\t    ");
    _builder.append("return Utils.settings.development;");
    _builder.newLine();
    _builder.append("\t");
    _builder.append("}");
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("    ");
    _builder.append("static httpGet(url, authorize, commandData) {");
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("return new Promise((resolve, reject) => {");
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("\t\t    ");
    _builder.append("const completeUrl = url + AppUtils.queryParamString(url);");
    _builder.newLine();
    _builder.append("\t\t    ");
    ...
    _builder.newLine();
    _builder.append("        ");
    _builder.append("return AppUtils.httpChange(\"POST\", authorize, url, data);");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("}");
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("        ");
    _builder.append("return AppUtils.httpChange(\"PUT\", authorize, url, data);");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("}");
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("        ");
    _builder.append("return AppUtils.httpChange(\"DELETE\", authorize, url, data);");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("}");
    _builder.newLine();
