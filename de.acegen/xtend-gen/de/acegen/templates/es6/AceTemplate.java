...
public class AceTemplate {
  ...
  public CharSequence generateACEController() {
    ...
    _builder.newLine();
    _builder.append("            ");
    _builder.append("if (ACEController.timeline.length < AppUtils.getMaxTimelineSize()) {");
    _builder.newLine();
    _builder.append("\t\t\t\t");
    ...
    _builder.newLine();
    _builder.append("\t\t\t\t");
    _builder.append("console.debug(`timeline size ${AppUtils.getMaxTimelineSize()} exceeded - item was not added`, item);");
    _builder.newLine();
    _builder.append("\t\t\t");
    _builder.append("}");
    _builder.newLine();
