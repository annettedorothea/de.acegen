...
public class ReactTemplate {
  ...
  public CharSequence generateContainer() {
    ...
    _builder.append("import React from \'react\';");
    _builder.newLine();
    _builder.append("import { uiElement } from \"../../src/components/ContainerNew\";");
    _builder.newLine();
    _builder.newLine();
  ...
  public CharSequence generateReactHelper(final HttpClient httpClient) {
    ...
    _builder.newLine();
    _builder.append("function key() {");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("const chars = \'0123456789abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ\';");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("let result = \'\';");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("for (let i = 10; i > 0; --i) result += chars[Math.floor(Math.random() * chars.length)];");
    _builder.newLine();
    _builder.append("    ");
    ...
    _builder.newLine();
    _builder.append("    ");
    _builder.append("options.key = options.id ? options.id : key();");
    _builder.newLine();
    _builder.append("    ");
  ...
  protected CharSequence _components(final SingleClientAttribute it) {
    StringConcatenation _builder = new StringConcatenation();
    {
      ...
      if (_greaterThan) {
        ...
        String _reactComponentName = this._es6Extension.reactComponentName(it);
        _builder.append(_reactComponentName, "    ");
        _builder.append(" {...normalize(options)} key={key()}/>");
        _builder.newLineIfNotEmpty();
        _builder.append("}");
        _builder.newLine();
        {
