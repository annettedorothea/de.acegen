...
public class ReactTemplate {
  ...
  public CharSequence generateContainer() {
    ...
    _builder.newLine();
    _builder.newLine();
    _builder.append("export const setState = (newState) => {");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("console.log(\"setState newState\", newState);");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("if (listeners.setMyState) {");
    _builder.newLine();
    _builder.append("        ");
    _builder.append("listeners.setMyState(newState);");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("}");
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.newLine();
    _builder.append("let listeners = {};");
    _builder.newLine();
    _builder.newLine();
    _builder.append("export const ContainerComponent = (props) => {");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("const [state, setMyState] = useState(AppState.getAppState());");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("listeners.setMyState = setMyState;");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("console.log(\"ContainerComponent state\", state);");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("return uiElement(state);");
    _builder.newLine();
    _builder.append("}");
    _builder.newLine();
    _builder.append("\t\t");
