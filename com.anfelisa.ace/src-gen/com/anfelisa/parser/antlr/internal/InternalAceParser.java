...
public class InternalAceParser extends AbstractInternalAntlrParser {
    public static final String[] tokenNames = new String[] {
        "<invalid>", "<EOR>", "<DOWN>", "<UP>", "RULE_ID", "RULE_INT", "RULE_STRING", "RULE_ML_COMMENT", "RULE_SL_COMMENT", "RULE_WS", "RULE_ANY_OTHER", "'target'", "'ES6'", "'JAVA'", "'models'", "'{'", "'}'", "'data'", "'actions'", "'commands'", "'events'", "'views'", "'persistent'", "'('", "')'", "':'", "'Unique'", "'PrimaryKey'", "'references'", "'uses'", "'executes'", "'on'", "'publishes'", "'triggers'", "'listenedToBy'", "'.'", "'POST'", "'PUT'", "'DELETE'", "'GET'", "'Serial'", "'Integer'", "'String'", "'Float'", "'Boolean'", "'DateTime'", "'Long'", "'NotEmpty'", "'NotNull'"
    };
            ...
            do {
            	...
            	case 1 :
            	    ...
            	    do {
            	        ...
            	        if ( (LA6_0==RULE_ID||(LA6_0>=36 && LA6_0<=39)) ) {
            	            alt6=1;
            	        }
    ...
    public final EObject ruleModel() throws RecognitionException {
        ...
        try {
            ...
            do {
                ...
                if ( ((LA15_0>=26 && LA15_0<=27)||(LA15_0>=40 && LA15_0<=48)) ) {
                    alt15=1;
                }
    ...
    // InternalAce.g:481:1: ruleAttribute returns [EObject current=null] : ( ( (lv_unique_0_0= 'Unique' ) )? ( (lv_primaryKey_1_0= 'PrimaryKey' ) )? ( (lv_constraint_2_0= ruleConstraint ) )? ( (lv_type_3_0= ruleModelType ) ) ( (lv_name_4_0= RULE_ID ) ) (otherlv_5= 'references' ( ( ruleQualifiedName ) ) )? ) ;
    public final EObject ruleAttribute() throws RecognitionException {
        ...
        try {
            // InternalAce.g:487:2: ( ( ( (lv_unique_0_0= 'Unique' ) )? ( (lv_primaryKey_1_0= 'PrimaryKey' ) )? ( (lv_constraint_2_0= ruleConstraint ) )? ( (lv_type_3_0= ruleModelType ) ) ( (lv_name_4_0= RULE_ID ) ) (otherlv_5= 'references' ( ( ruleQualifiedName ) ) )? ) )
            // InternalAce.g:488:2: ( ( (lv_unique_0_0= 'Unique' ) )? ( (lv_primaryKey_1_0= 'PrimaryKey' ) )? ( (lv_constraint_2_0= ruleConstraint ) )? ( (lv_type_3_0= ruleModelType ) ) ( (lv_name_4_0= RULE_ID ) ) (otherlv_5= 'references' ( ( ruleQualifiedName ) ) )? )
            {
            // InternalAce.g:488:2: ( ( (lv_unique_0_0= 'Unique' ) )? ( (lv_primaryKey_1_0= 'PrimaryKey' ) )? ( (lv_constraint_2_0= ruleConstraint ) )? ( (lv_type_3_0= ruleModelType ) ) ( (lv_name_4_0= RULE_ID ) ) (otherlv_5= 'references' ( ( ruleQualifiedName ) ) )? )
            // InternalAce.g:489:3: ( (lv_unique_0_0= 'Unique' ) )? ( (lv_primaryKey_1_0= 'PrimaryKey' ) )? ( (lv_constraint_2_0= ruleConstraint ) )? ( (lv_type_3_0= ruleModelType ) ) ( (lv_name_4_0= RULE_ID ) ) (otherlv_5= 'references' ( ( ruleQualifiedName ) ) )?
            {
            ...
            // InternalAce.g:503:3: ( (lv_primaryKey_1_0= 'PrimaryKey' ) )?
            int alt18=2;
            ...
            switch (alt18) {
                case 1 :
                    // InternalAce.g:504:4: (lv_primaryKey_1_0= 'PrimaryKey' )
                    {
                    // InternalAce.g:504:4: (lv_primaryKey_1_0= 'PrimaryKey' )
                    // InternalAce.g:505:5: lv_primaryKey_1_0= 'PrimaryKey'
                    {
                    lv_primaryKey_1_0=(Token)match(input,27,FOLLOW_20); 
            ...
            // InternalAce.g:517:3: ( (lv_constraint_2_0= ruleConstraint ) )?
            int alt19=2;
            ...
            switch (alt19) {
                case 1 :
                    // InternalAce.g:518:4: (lv_constraint_2_0= ruleConstraint )
                    {
                    // InternalAce.g:518:4: (lv_constraint_2_0= ruleConstraint )
                    // InternalAce.g:519:5: lv_constraint_2_0= ruleConstraint
                    {
            ...
            // InternalAce.g:536:3: ( (lv_type_3_0= ruleModelType ) )
            // InternalAce.g:537:4: (lv_type_3_0= ruleModelType )
            {
            // InternalAce.g:537:4: (lv_type_3_0= ruleModelType )
            // InternalAce.g:538:5: lv_type_3_0= ruleModelType
            {
            ...
            // InternalAce.g:555:3: ( (lv_name_4_0= RULE_ID ) )
            // InternalAce.g:556:4: (lv_name_4_0= RULE_ID )
            {
            // InternalAce.g:556:4: (lv_name_4_0= RULE_ID )
            // InternalAce.g:557:5: lv_name_4_0= RULE_ID
            {
            ...
            // InternalAce.g:573:3: (otherlv_5= 'references' ( ( ruleQualifiedName ) ) )?
            int alt20=2;
            ...
            switch (alt20) {
                case 1 :
                    // InternalAce.g:574:4: otherlv_5= 'references' ( ( ruleQualifiedName ) )
                    {
                    otherlv_5=(Token)match(input,28,FOLLOW_15); 

                    				newLeafNode(otherlv_5, grammarAccess.getAttributeAccess().getReferencesKeyword_5_0());
                    			
                    // InternalAce.g:578:4: ( ( ruleQualifiedName ) )
                    // InternalAce.g:579:5: ( ruleQualifiedName )
                    {
                    // InternalAce.g:579:5: ( ruleQualifiedName )
                    // InternalAce.g:580:6: ruleQualifiedName
                    {
    ...
    // InternalAce.g:599:1: entryRuleAction returns [EObject current=null] : iv_ruleAction= ruleAction EOF ;
    public final EObject entryRuleAction() throws RecognitionException {
        ...
        try {
            // InternalAce.g:599:47: (iv_ruleAction= ruleAction EOF )
            // InternalAce.g:600:2: iv_ruleAction= ruleAction EOF
            {
    ...
    // InternalAce.g:606:1: ruleAction returns [EObject current=null] : ( ( (lv_type_0_0= ruleFunctionType ) )? ( (lv_name_1_0= RULE_ID ) ) (otherlv_2= 'uses' ( ( ruleQualifiedName ) ) )? (otherlv_4= 'executes' ( ( ruleQualifiedName ) ) )? ) ;
    public final EObject ruleAction() throws RecognitionException {
        ...
        try {
            // InternalAce.g:612:2: ( ( ( (lv_type_0_0= ruleFunctionType ) )? ( (lv_name_1_0= RULE_ID ) ) (otherlv_2= 'uses' ( ( ruleQualifiedName ) ) )? (otherlv_4= 'executes' ( ( ruleQualifiedName ) ) )? ) )
            // InternalAce.g:613:2: ( ( (lv_type_0_0= ruleFunctionType ) )? ( (lv_name_1_0= RULE_ID ) ) (otherlv_2= 'uses' ( ( ruleQualifiedName ) ) )? (otherlv_4= 'executes' ( ( ruleQualifiedName ) ) )? )
            {
            // InternalAce.g:613:2: ( ( (lv_type_0_0= ruleFunctionType ) )? ( (lv_name_1_0= RULE_ID ) ) (otherlv_2= 'uses' ( ( ruleQualifiedName ) ) )? (otherlv_4= 'executes' ( ( ruleQualifiedName ) ) )? )
            // InternalAce.g:614:3: ( (lv_type_0_0= ruleFunctionType ) )? ( (lv_name_1_0= RULE_ID ) ) (otherlv_2= 'uses' ( ( ruleQualifiedName ) ) )? (otherlv_4= 'executes' ( ( ruleQualifiedName ) ) )?
            {
            // InternalAce.g:614:3: ( (lv_type_0_0= ruleFunctionType ) )?
            int alt21=2;
            ...
            switch (alt21) {
                case 1 :
                    // InternalAce.g:615:4: (lv_type_0_0= ruleFunctionType )
                    {
                    // InternalAce.g:615:4: (lv_type_0_0= ruleFunctionType )
                    // InternalAce.g:616:5: lv_type_0_0= ruleFunctionType
                    {
            ...
            // InternalAce.g:633:3: ( (lv_name_1_0= RULE_ID ) )
            // InternalAce.g:634:4: (lv_name_1_0= RULE_ID )
            {
            // InternalAce.g:634:4: (lv_name_1_0= RULE_ID )
            // InternalAce.g:635:5: lv_name_1_0= RULE_ID
            {
            ...
            // InternalAce.g:651:3: (otherlv_2= 'uses' ( ( ruleQualifiedName ) ) )?
            int alt22=2;
            ...
            switch (alt22) {
                case 1 :
                    // InternalAce.g:652:4: otherlv_2= 'uses' ( ( ruleQualifiedName ) )
                    {
                    otherlv_2=(Token)match(input,29,FOLLOW_15); 

                    				newLeafNode(otherlv_2, grammarAccess.getActionAccess().getUsesKeyword_2_0());
                    			
                    // InternalAce.g:656:4: ( ( ruleQualifiedName ) )
                    // InternalAce.g:657:5: ( ruleQualifiedName )
                    {
                    // InternalAce.g:657:5: ( ruleQualifiedName )
                    // InternalAce.g:658:6: ruleQualifiedName
                    {
            ...
            // InternalAce.g:673:3: (otherlv_4= 'executes' ( ( ruleQualifiedName ) ) )?
            int alt23=2;
            ...
            switch (alt23) {
                case 1 :
                    // InternalAce.g:674:4: otherlv_4= 'executes' ( ( ruleQualifiedName ) )
                    {
                    otherlv_4=(Token)match(input,30,FOLLOW_15); 

                    				newLeafNode(otherlv_4, grammarAccess.getActionAccess().getExecutesKeyword_3_0());
                    			
                    // InternalAce.g:678:4: ( ( ruleQualifiedName ) )
                    // InternalAce.g:679:5: ( ruleQualifiedName )
                    {
                    // InternalAce.g:679:5: ( ruleQualifiedName )
                    // InternalAce.g:680:6: ruleQualifiedName
                    {
    ...
    // InternalAce.g:699:1: entryRuleCommand returns [EObject current=null] : iv_ruleCommand= ruleCommand EOF ;
    public final EObject entryRuleCommand() throws RecognitionException {
        ...
        try {
            // InternalAce.g:699:48: (iv_ruleCommand= ruleCommand EOF )
            // InternalAce.g:700:2: iv_ruleCommand= ruleCommand EOF
            {
    ...
    // InternalAce.g:706:1: ruleCommand returns [EObject current=null] : ( ( (lv_name_0_0= RULE_ID ) ) (otherlv_1= 'uses' ( ( ruleQualifiedName ) ) )? (otherlv_3= '{' ( (lv_eventsOnOutcome_4_0= ruleEventOnOutcome ) )* otherlv_5= '}' )* ) ;
    public final EObject ruleCommand() throws RecognitionException {
        ...
        try {
            // InternalAce.g:712:2: ( ( ( (lv_name_0_0= RULE_ID ) ) (otherlv_1= 'uses' ( ( ruleQualifiedName ) ) )? (otherlv_3= '{' ( (lv_eventsOnOutcome_4_0= ruleEventOnOutcome ) )* otherlv_5= '}' )* ) )
            // InternalAce.g:713:2: ( ( (lv_name_0_0= RULE_ID ) ) (otherlv_1= 'uses' ( ( ruleQualifiedName ) ) )? (otherlv_3= '{' ( (lv_eventsOnOutcome_4_0= ruleEventOnOutcome ) )* otherlv_5= '}' )* )
            {
            // InternalAce.g:713:2: ( ( (lv_name_0_0= RULE_ID ) ) (otherlv_1= 'uses' ( ( ruleQualifiedName ) ) )? (otherlv_3= '{' ( (lv_eventsOnOutcome_4_0= ruleEventOnOutcome ) )* otherlv_5= '}' )* )
            // InternalAce.g:714:3: ( (lv_name_0_0= RULE_ID ) ) (otherlv_1= 'uses' ( ( ruleQualifiedName ) ) )? (otherlv_3= '{' ( (lv_eventsOnOutcome_4_0= ruleEventOnOutcome ) )* otherlv_5= '}' )*
            {
            // InternalAce.g:714:3: ( (lv_name_0_0= RULE_ID ) )
            // InternalAce.g:715:4: (lv_name_0_0= RULE_ID )
            {
            // InternalAce.g:715:4: (lv_name_0_0= RULE_ID )
            // InternalAce.g:716:5: lv_name_0_0= RULE_ID
            {
            ...
            // InternalAce.g:732:3: (otherlv_1= 'uses' ( ( ruleQualifiedName ) ) )?
            int alt24=2;
            ...
            switch (alt24) {
                case 1 :
                    // InternalAce.g:733:4: otherlv_1= 'uses' ( ( ruleQualifiedName ) )
                    {
            ...
            // InternalAce.g:754:3: (otherlv_3= '{' ( (lv_eventsOnOutcome_4_0= ruleEventOnOutcome ) )* otherlv_5= '}' )*
            loop26:
            do {
                int alt26=2;
                ...
                switch (alt26) {
            	case 1 :
            	    // InternalAce.g:755:4: otherlv_3= '{' ( (lv_eventsOnOutcome_4_0= ruleEventOnOutcome ) )* otherlv_5= '}'
            	    {
            	    ...
            	    // InternalAce.g:759:4: ( (lv_eventsOnOutcome_4_0= ruleEventOnOutcome ) )*
            	    loop25:
            	    do {
            	        int alt25=2;
            	        ...
            	        switch (alt25) {
            	    	case 1 :
            	    	    // InternalAce.g:760:5: (lv_eventsOnOutcome_4_0= ruleEventOnOutcome )
            	    	    {
            	    	    // InternalAce.g:760:5: (lv_eventsOnOutcome_4_0= ruleEventOnOutcome )
            	    	    // InternalAce.g:761:6: lv_eventsOnOutcome_4_0= ruleEventOnOutcome
            	    	    {
    ...
    // InternalAce.g:787:1: entryRuleEventOnOutcome returns [EObject current=null] : iv_ruleEventOnOutcome= ruleEventOnOutcome EOF ;
    public final EObject entryRuleEventOnOutcome() throws RecognitionException {
        ...
        try {
            // InternalAce.g:787:55: (iv_ruleEventOnOutcome= ruleEventOnOutcome EOF )
            // InternalAce.g:788:2: iv_ruleEventOnOutcome= ruleEventOnOutcome EOF
            {
    ...
    // InternalAce.g:794:1: ruleEventOnOutcome returns [EObject current=null] : (otherlv_0= 'on' ( (lv_outcome_1_0= RULE_ID ) ) (otherlv_2= 'publishes' otherlv_3= '(' ( ( ruleQualifiedName ) )* otherlv_5= ')' )? (otherlv_6= 'triggers' otherlv_7= '(' ( ( ruleQualifiedName ) )* otherlv_9= ')' )? ) ;
    public final EObject ruleEventOnOutcome() throws RecognitionException {
        ...
        try {
            // InternalAce.g:800:2: ( (otherlv_0= 'on' ( (lv_outcome_1_0= RULE_ID ) ) (otherlv_2= 'publishes' otherlv_3= '(' ( ( ruleQualifiedName ) )* otherlv_5= ')' )? (otherlv_6= 'triggers' otherlv_7= '(' ( ( ruleQualifiedName ) )* otherlv_9= ')' )? ) )
            // InternalAce.g:801:2: (otherlv_0= 'on' ( (lv_outcome_1_0= RULE_ID ) ) (otherlv_2= 'publishes' otherlv_3= '(' ( ( ruleQualifiedName ) )* otherlv_5= ')' )? (otherlv_6= 'triggers' otherlv_7= '(' ( ( ruleQualifiedName ) )* otherlv_9= ')' )? )
            {
            // InternalAce.g:801:2: (otherlv_0= 'on' ( (lv_outcome_1_0= RULE_ID ) ) (otherlv_2= 'publishes' otherlv_3= '(' ( ( ruleQualifiedName ) )* otherlv_5= ')' )? (otherlv_6= 'triggers' otherlv_7= '(' ( ( ruleQualifiedName ) )* otherlv_9= ')' )? )
            // InternalAce.g:802:3: otherlv_0= 'on' ( (lv_outcome_1_0= RULE_ID ) ) (otherlv_2= 'publishes' otherlv_3= '(' ( ( ruleQualifiedName ) )* otherlv_5= ')' )? (otherlv_6= 'triggers' otherlv_7= '(' ( ( ruleQualifiedName ) )* otherlv_9= ')' )?
            {
            otherlv_0=(Token)match(input,31,FOLLOW_15); 

            			newLeafNode(otherlv_0, grammarAccess.getEventOnOutcomeAccess().getOnKeyword_0());
            		
            // InternalAce.g:806:3: ( (lv_outcome_1_0= RULE_ID ) )
            // InternalAce.g:807:4: (lv_outcome_1_0= RULE_ID )
            {
            // InternalAce.g:807:4: (lv_outcome_1_0= RULE_ID )
            // InternalAce.g:808:5: lv_outcome_1_0= RULE_ID
            {
            lv_outcome_1_0=(Token)match(input,RULE_ID,FOLLOW_27); 
            ...
            // InternalAce.g:824:3: (otherlv_2= 'publishes' otherlv_3= '(' ( ( ruleQualifiedName ) )* otherlv_5= ')' )?
            int alt28=2;
            ...
            switch (alt28) {
                case 1 :
                    // InternalAce.g:825:4: otherlv_2= 'publishes' otherlv_3= '(' ( ( ruleQualifiedName ) )* otherlv_5= ')'
                    {
                    ...
                    // InternalAce.g:833:4: ( ( ruleQualifiedName ) )*
                    loop27:
                    do {
                        int alt27=2;
                        ...
                        switch (alt27) {
                    	case 1 :
                    	    // InternalAce.g:834:5: ( ruleQualifiedName )
                    	    {
                    	    // InternalAce.g:834:5: ( ruleQualifiedName )
                    	    // InternalAce.g:835:6: ruleQualifiedName
                    	    {
            ...
            // InternalAce.g:854:3: (otherlv_6= 'triggers' otherlv_7= '(' ( ( ruleQualifiedName ) )* otherlv_9= ')' )?
            int alt30=2;
            ...
            switch (alt30) {
                case 1 :
                    // InternalAce.g:855:4: otherlv_6= 'triggers' otherlv_7= '(' ( ( ruleQualifiedName ) )* otherlv_9= ')'
                    {
                    ...
                    // InternalAce.g:863:4: ( ( ruleQualifiedName ) )*
                    loop29:
                    do {
                        int alt29=2;
                        ...
                        switch (alt29) {
                    	case 1 :
                    	    // InternalAce.g:864:5: ( ruleQualifiedName )
                    	    {
                    	    // InternalAce.g:864:5: ( ruleQualifiedName )
                    	    // InternalAce.g:865:6: ruleQualifiedName
                    	    {
    ...
    // InternalAce.g:888:1: entryRuleEvent returns [EObject current=null] : iv_ruleEvent= ruleEvent EOF ;
    public final EObject entryRuleEvent() throws RecognitionException {
        ...
        try {
            // InternalAce.g:888:46: (iv_ruleEvent= ruleEvent EOF )
            // InternalAce.g:889:2: iv_ruleEvent= ruleEvent EOF
            {
    ...
    // InternalAce.g:895:1: ruleEvent returns [EObject current=null] : ( ( (lv_name_0_0= RULE_ID ) ) (otherlv_1= 'uses' ( ( ruleQualifiedName ) ) )? (otherlv_3= 'listenedToBy' otherlv_4= '(' ( ( ruleQualifiedName ) )* otherlv_6= ')' )? ) ;
    public final EObject ruleEvent() throws RecognitionException {
        ...
        try {
            // InternalAce.g:901:2: ( ( ( (lv_name_0_0= RULE_ID ) ) (otherlv_1= 'uses' ( ( ruleQualifiedName ) ) )? (otherlv_3= 'listenedToBy' otherlv_4= '(' ( ( ruleQualifiedName ) )* otherlv_6= ')' )? ) )
            // InternalAce.g:902:2: ( ( (lv_name_0_0= RULE_ID ) ) (otherlv_1= 'uses' ( ( ruleQualifiedName ) ) )? (otherlv_3= 'listenedToBy' otherlv_4= '(' ( ( ruleQualifiedName ) )* otherlv_6= ')' )? )
            {
            // InternalAce.g:902:2: ( ( (lv_name_0_0= RULE_ID ) ) (otherlv_1= 'uses' ( ( ruleQualifiedName ) ) )? (otherlv_3= 'listenedToBy' otherlv_4= '(' ( ( ruleQualifiedName ) )* otherlv_6= ')' )? )
            // InternalAce.g:903:3: ( (lv_name_0_0= RULE_ID ) ) (otherlv_1= 'uses' ( ( ruleQualifiedName ) ) )? (otherlv_3= 'listenedToBy' otherlv_4= '(' ( ( ruleQualifiedName ) )* otherlv_6= ')' )?
            {
            // InternalAce.g:903:3: ( (lv_name_0_0= RULE_ID ) )
            // InternalAce.g:904:4: (lv_name_0_0= RULE_ID )
            {
            // InternalAce.g:904:4: (lv_name_0_0= RULE_ID )
            // InternalAce.g:905:5: lv_name_0_0= RULE_ID
            {
            ...
            // InternalAce.g:921:3: (otherlv_1= 'uses' ( ( ruleQualifiedName ) ) )?
            int alt31=2;
            ...
            switch (alt31) {
                case 1 :
                    // InternalAce.g:922:4: otherlv_1= 'uses' ( ( ruleQualifiedName ) )
                    {
                    otherlv_1=(Token)match(input,29,FOLLOW_15); 

                    				newLeafNode(otherlv_1, grammarAccess.getEventAccess().getUsesKeyword_1_0());
                    			
                    // InternalAce.g:926:4: ( ( ruleQualifiedName ) )
                    // InternalAce.g:927:5: ( ruleQualifiedName )
                    {
                    // InternalAce.g:927:5: ( ruleQualifiedName )
                    // InternalAce.g:928:6: ruleQualifiedName
                    {
            ...
            // InternalAce.g:943:3: (otherlv_3= 'listenedToBy' otherlv_4= '(' ( ( ruleQualifiedName ) )* otherlv_6= ')' )?
            int alt33=2;
            ...
            switch (alt33) {
                case 1 :
                    // InternalAce.g:944:4: otherlv_3= 'listenedToBy' otherlv_4= '(' ( ( ruleQualifiedName ) )* otherlv_6= ')'
                    {
                    ...
                    // InternalAce.g:952:4: ( ( ruleQualifiedName ) )*
                    loop32:
                    do {
                        int alt32=2;
                        ...
                        switch (alt32) {
                    	case 1 :
                    	    // InternalAce.g:953:5: ( ruleQualifiedName )
                    	    {
                    	    // InternalAce.g:953:5: ( ruleQualifiedName )
                    	    // InternalAce.g:954:6: ruleQualifiedName
                    	    {
    ...
    // InternalAce.g:977:1: entryRuleView returns [EObject current=null] : iv_ruleView= ruleView EOF ;
    public final EObject entryRuleView() throws RecognitionException {
        ...
        try {
            // InternalAce.g:977:45: (iv_ruleView= ruleView EOF )
            // InternalAce.g:978:2: iv_ruleView= ruleView EOF
            {
    ...
    // InternalAce.g:984:1: ruleView returns [EObject current=null] : ( ( (lv_name_0_0= RULE_ID ) ) (otherlv_1= '{' ( (lv_renderFunctions_2_0= ruleViewFunction ) )* otherlv_3= '}' )* ) ;
    public final EObject ruleView() throws RecognitionException {
        ...
        try {
            // InternalAce.g:990:2: ( ( ( (lv_name_0_0= RULE_ID ) ) (otherlv_1= '{' ( (lv_renderFunctions_2_0= ruleViewFunction ) )* otherlv_3= '}' )* ) )
            // InternalAce.g:991:2: ( ( (lv_name_0_0= RULE_ID ) ) (otherlv_1= '{' ( (lv_renderFunctions_2_0= ruleViewFunction ) )* otherlv_3= '}' )* )
            {
            // InternalAce.g:991:2: ( ( (lv_name_0_0= RULE_ID ) ) (otherlv_1= '{' ( (lv_renderFunctions_2_0= ruleViewFunction ) )* otherlv_3= '}' )* )
            // InternalAce.g:992:3: ( (lv_name_0_0= RULE_ID ) ) (otherlv_1= '{' ( (lv_renderFunctions_2_0= ruleViewFunction ) )* otherlv_3= '}' )*
            {
            // InternalAce.g:992:3: ( (lv_name_0_0= RULE_ID ) )
            // InternalAce.g:993:4: (lv_name_0_0= RULE_ID )
            {
            // InternalAce.g:993:4: (lv_name_0_0= RULE_ID )
            // InternalAce.g:994:5: lv_name_0_0= RULE_ID
            {
            ...
            // InternalAce.g:1010:3: (otherlv_1= '{' ( (lv_renderFunctions_2_0= ruleViewFunction ) )* otherlv_3= '}' )*
            loop35:
            do {
                int alt35=2;
                ...
                switch (alt35) {
            	case 1 :
            	    // InternalAce.g:1011:4: otherlv_1= '{' ( (lv_renderFunctions_2_0= ruleViewFunction ) )* otherlv_3= '}'
            	    {
            	    otherlv_1=(Token)match(input,15,FOLLOW_8); 

            	    				newLeafNode(otherlv_1, grammarAccess.getViewAccess().getLeftCurlyBracketKeyword_1_0());
            	    			
            	    // InternalAce.g:1015:4: ( (lv_renderFunctions_2_0= ruleViewFunction ) )*
            	    loop34:
            	    do {
            	        int alt34=2;
            	        ...
            	        switch (alt34) {
            	    	case 1 :
            	    	    // InternalAce.g:1016:5: (lv_renderFunctions_2_0= ruleViewFunction )
            	    	    {
            	    	    // InternalAce.g:1016:5: (lv_renderFunctions_2_0= ruleViewFunction )
            	    	    // InternalAce.g:1017:6: lv_renderFunctions_2_0= ruleViewFunction
            	    	    {
    ...
    // InternalAce.g:1043:1: entryRuleViewFunction returns [EObject current=null] : iv_ruleViewFunction= ruleViewFunction EOF ;
    public final EObject entryRuleViewFunction() throws RecognitionException {
        ...
        try {
            // InternalAce.g:1043:53: (iv_ruleViewFunction= ruleViewFunction EOF )
            // InternalAce.g:1044:2: iv_ruleViewFunction= ruleViewFunction EOF
            {
    ...
    // InternalAce.g:1050:1: ruleViewFunction returns [EObject current=null] : ( ( (lv_name_0_0= RULE_ID ) ) (otherlv_1= '(' ( ( ruleQualifiedName ) ) otherlv_3= ')' )? ) ;
    public final EObject ruleViewFunction() throws RecognitionException {
        ...
        try {
            // InternalAce.g:1056:2: ( ( ( (lv_name_0_0= RULE_ID ) ) (otherlv_1= '(' ( ( ruleQualifiedName ) ) otherlv_3= ')' )? ) )
            // InternalAce.g:1057:2: ( ( (lv_name_0_0= RULE_ID ) ) (otherlv_1= '(' ( ( ruleQualifiedName ) ) otherlv_3= ')' )? )
            {
            // InternalAce.g:1057:2: ( ( (lv_name_0_0= RULE_ID ) ) (otherlv_1= '(' ( ( ruleQualifiedName ) ) otherlv_3= ')' )? )
            // InternalAce.g:1058:3: ( (lv_name_0_0= RULE_ID ) ) (otherlv_1= '(' ( ( ruleQualifiedName ) ) otherlv_3= ')' )?
            {
            // InternalAce.g:1058:3: ( (lv_name_0_0= RULE_ID ) )
            // InternalAce.g:1059:4: (lv_name_0_0= RULE_ID )
            {
            // InternalAce.g:1059:4: (lv_name_0_0= RULE_ID )
            // InternalAce.g:1060:5: lv_name_0_0= RULE_ID
            {
            ...
            // InternalAce.g:1076:3: (otherlv_1= '(' ( ( ruleQualifiedName ) ) otherlv_3= ')' )?
            int alt36=2;
            ...
            switch (alt36) {
                case 1 :
                    // InternalAce.g:1077:4: otherlv_1= '(' ( ( ruleQualifiedName ) ) otherlv_3= ')'
                    {
                    ...
                    // InternalAce.g:1081:4: ( ( ruleQualifiedName ) )
                    // InternalAce.g:1082:5: ( ruleQualifiedName )
                    {
                    // InternalAce.g:1082:5: ( ruleQualifiedName )
                    // InternalAce.g:1083:6: ruleQualifiedName
                    {
    ...
    // InternalAce.g:1106:1: entryRuleQualifiedName returns [String current=null] : iv_ruleQualifiedName= ruleQualifiedName EOF ;
    public final String entryRuleQualifiedName() throws RecognitionException {
        ...
        try {
            // InternalAce.g:1106:53: (iv_ruleQualifiedName= ruleQualifiedName EOF )
            // InternalAce.g:1107:2: iv_ruleQualifiedName= ruleQualifiedName EOF
            {
    ...
    // InternalAce.g:1113:1: ruleQualifiedName returns [AntlrDatatypeRuleToken current=new AntlrDatatypeRuleToken()] : (this_ID_0= RULE_ID (kw= '.' this_ID_2= RULE_ID )* ) ;
    public final AntlrDatatypeRuleToken ruleQualifiedName() throws RecognitionException {
        ...
        try {
            // InternalAce.g:1119:2: ( (this_ID_0= RULE_ID (kw= '.' this_ID_2= RULE_ID )* ) )
            // InternalAce.g:1120:2: (this_ID_0= RULE_ID (kw= '.' this_ID_2= RULE_ID )* )
            {
            // InternalAce.g:1120:2: (this_ID_0= RULE_ID (kw= '.' this_ID_2= RULE_ID )* )
            // InternalAce.g:1121:3: this_ID_0= RULE_ID (kw= '.' this_ID_2= RULE_ID )*
            {
            ...
            // InternalAce.g:1128:3: (kw= '.' this_ID_2= RULE_ID )*
            loop37:
            do {
                int alt37=2;
                ...
                switch (alt37) {
            	case 1 :
            	    // InternalAce.g:1129:4: kw= '.' this_ID_2= RULE_ID
            	    {
    ...
    // InternalAce.g:1146:1: entryRuleFunctionType returns [String current=null] : iv_ruleFunctionType= ruleFunctionType EOF ;
    public final String entryRuleFunctionType() throws RecognitionException {
        ...
        try {
            // InternalAce.g:1146:52: (iv_ruleFunctionType= ruleFunctionType EOF )
            // InternalAce.g:1147:2: iv_ruleFunctionType= ruleFunctionType EOF
            {
    ...
    // InternalAce.g:1153:1: ruleFunctionType returns [AntlrDatatypeRuleToken current=new AntlrDatatypeRuleToken()] : (kw= 'POST' | kw= 'PUT' | kw= 'DELETE' | kw= 'GET' ) ;
    public final AntlrDatatypeRuleToken ruleFunctionType() throws RecognitionException {
        ...
        try {
            // InternalAce.g:1159:2: ( (kw= 'POST' | kw= 'PUT' | kw= 'DELETE' | kw= 'GET' ) )
            // InternalAce.g:1160:2: (kw= 'POST' | kw= 'PUT' | kw= 'DELETE' | kw= 'GET' )
            {
            // InternalAce.g:1160:2: (kw= 'POST' | kw= 'PUT' | kw= 'DELETE' | kw= 'GET' )
            int alt38=4;
            switch ( input.LA(1) ) {
            ...
            switch (alt38) {
                ...
                case 2 :
                    ...
                    break;
                case 3 :
                    // InternalAce.g:1173:3: kw= 'DELETE'
                    {
    ...
    // InternalAce.g:1188:1: entryRuleModelType returns [String current=null] : iv_ruleModelType= ruleModelType EOF ;
    public final String entryRuleModelType() throws RecognitionException {
        ...
        try {
            // InternalAce.g:1188:49: (iv_ruleModelType= ruleModelType EOF )
            // InternalAce.g:1189:2: iv_ruleModelType= ruleModelType EOF
            {
    ...
    // InternalAce.g:1195:1: ruleModelType returns [AntlrDatatypeRuleToken current=new AntlrDatatypeRuleToken()] : (kw= 'Serial' | kw= 'Integer' | kw= 'String' | kw= 'Float' | kw= 'Boolean' | kw= 'DateTime' | kw= 'Long' ) ;
    public final AntlrDatatypeRuleToken ruleModelType() throws RecognitionException {
        ...
        try {
            // InternalAce.g:1201:2: ( (kw= 'Serial' | kw= 'Integer' | kw= 'String' | kw= 'Float' | kw= 'Boolean' | kw= 'DateTime' | kw= 'Long' ) )
            // InternalAce.g:1202:2: (kw= 'Serial' | kw= 'Integer' | kw= 'String' | kw= 'Float' | kw= 'Boolean' | kw= 'DateTime' | kw= 'Long' )
            {
            // InternalAce.g:1202:2: (kw= 'Serial' | kw= 'Integer' | kw= 'String' | kw= 'Float' | kw= 'Boolean' | kw= 'DateTime' | kw= 'Long' )
            int alt39=7;
            switch ( input.LA(1) ) {
            ...
            switch (alt39) {
                case 1 :
                    // InternalAce.g:1203:3: kw= 'Serial'
                    {
                    ...
                    break;
                case 2 :
                    // InternalAce.g:1209:3: kw= 'Integer'
                    {
                    ...
                    break;
                case 3 :
                    // InternalAce.g:1215:3: kw= 'String'
                    {
                ...
                case 4 :
                    ...
                    break;
                case 5 :
                    // InternalAce.g:1227:3: kw= 'Boolean'
                    {
                    ...
                    break;
                case 6 :
                    // InternalAce.g:1233:3: kw= 'DateTime'
                    {
    ...
    // InternalAce.g:1248:1: entryRuleConstraint returns [String current=null] : iv_ruleConstraint= ruleConstraint EOF ;
    public final String entryRuleConstraint() throws RecognitionException {
        ...
        try {
            // InternalAce.g:1248:50: (iv_ruleConstraint= ruleConstraint EOF )
            // InternalAce.g:1249:2: iv_ruleConstraint= ruleConstraint EOF
            {
    ...
    // InternalAce.g:1255:1: ruleConstraint returns [AntlrDatatypeRuleToken current=new AntlrDatatypeRuleToken()] : (kw= 'NotEmpty' | kw= 'NotNull' ) ;
    public final AntlrDatatypeRuleToken ruleConstraint() throws RecognitionException {
        ...
        try {
            // InternalAce.g:1261:2: ( (kw= 'NotEmpty' | kw= 'NotNull' ) )
            // InternalAce.g:1262:2: (kw= 'NotEmpty' | kw= 'NotNull' )
            {
            // InternalAce.g:1262:2: (kw= 'NotEmpty' | kw= 'NotNull' )
            int alt40=2;
            ...
            switch (alt40) {
                case 1 :
                    // InternalAce.g:1263:3: kw= 'NotEmpty'
                    {
                    ...
                    break;
                case 2 :
                    // InternalAce.g:1269:3: kw= 'NotNull'
                    {
    ...
    public static final BitSet FOLLOW_10 = new BitSet(new long[]{0x000000F000010010L});
    ...
    public static final BitSet FOLLOW_17 = new BitSet(new long[]{0x0001FF000D000000L});
    public static final BitSet FOLLOW_18 = new BitSet(new long[]{0x0000000002000000L});
    public static final BitSet FOLLOW_19 = new BitSet(new long[]{0x0000000001000010L});
    public static final BitSet FOLLOW_20 = new BitSet(new long[]{0x0001FF000C000000L});
    ...
    public static final BitSet FOLLOW_24 = new BitSet(new long[]{0x0000000020008002L});
