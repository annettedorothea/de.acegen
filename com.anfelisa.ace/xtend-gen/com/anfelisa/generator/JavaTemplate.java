...
public class JavaTemplate {
  ...
  public CharSequence generateDao(final Model it, final Project project) {
    ...
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("Update statement = handle.createStatement(\"TRUNCATE ");
    String _schema_11 = project.getSchema();
    _builder.append(_schema_11, "\t\t");
    _builder.append(".");
    String _table_14 = this._modelExtension.table(it);
    _builder.append(_table_14, "\t\t");
    _builder.append("\");");
    _builder.newLineIfNotEmpty();
    _builder.append("\t\t");
    _builder.append("statement.execute();");
  ...
  public CharSequence generateAbstractActionFile(final Action it, final Project project) {
    ...
    _builder.newLine();
    _builder.append("\t");
    _builder.append("public void initActionData(String json) {");
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("try {");
    _builder.newLine();
    _builder.append("\t\t\t");
    _builder.append("this.actionData = mapper.readValue(json, ");
