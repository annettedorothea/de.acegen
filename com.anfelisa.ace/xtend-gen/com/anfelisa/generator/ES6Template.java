...
public class ES6Template {
  ...
  public CharSequence generateInitialActionFile(final Action it) {
    ...
    _builder.newLine();
    _builder.append("    \t");
    _builder.append("if (localStorage.username) {");
    _builder.newLine();
    _builder.append("\t        ");
    _builder.append("this.actionParam.username = localStorage.username;");
    _builder.newLine();
    _builder.append("\t    ");
    _builder.append("}");
    _builder.newLine();
    _builder.append("    \t");
    _builder.append("if (localStorage.password) {");
    _builder.newLine();
    _builder.append("\t        ");
    _builder.append("this.actionParam.password = localStorage.password;");
    _builder.newLine();
    _builder.append("\t    ");
    _builder.append("}");
    _builder.newLine();
    _builder.append("    \t");
    _builder.append("if (localStorage.schema) {");
    _builder.newLine();
    _builder.append("\t        ");
    _builder.append("this.actionParam.schema = localStorage.schema;");
    _builder.newLine();
    _builder.append("\t    ");
    _builder.append("}");
    _builder.newLine();
    _builder.append("    \t");
    _builder.append("if (localStorage.role) {");
    _builder.newLine();
    _builder.append("\t        ");
    _builder.append("this.actionParam.role = localStorage.role;");
    _builder.newLine();
    _builder.append("\t    ");
    _builder.append("}");
    _builder.newLine();
    _builder.append("    \t");
    _builder.append("if (localStorage.language) {");
    _builder.newLine();
    _builder.append("\t        ");
    _builder.append("this.actionParam.language = localStorage.language;");
    _builder.newLine();
    _builder.append("\t    ");
    _builder.append("}");
    _builder.newLine();
    _builder.append("    \t");
    _builder.append("// capture user input");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("}");
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("    \t");
    _builder.append("if (this.actionParam.username) {");
    _builder.newLine();
    _builder.append("    \t\t");
    _builder.append("this.actionData.username = this.actionParam.username;");
    _builder.newLine();
    _builder.append("    \t");
    _builder.append("}");
    _builder.newLine();
    _builder.append("    \t");
    _builder.append("if (this.actionParam.password) {");
    _builder.newLine();
    _builder.append("    \t\t");
    _builder.append("this.actionData.password = this.actionParam.password;");
    _builder.newLine();
    _builder.append("    \t");
    _builder.append("}");
    _builder.newLine();
    _builder.append("    \t");
    _builder.append("if (this.actionParam.schema) {");
    _builder.newLine();
    _builder.append("    \t\t");
    _builder.append("this.actionData.schema = this.actionParam.schema;");
    _builder.newLine();
    _builder.append("    \t");
    _builder.append("}");
    _builder.newLine();
    _builder.append("    \t");
    _builder.append("if (this.actionParam.role) {");
    _builder.newLine();
    _builder.append("    \t\t");
    _builder.append("this.actionData.role = this.actionParam.role;");
    _builder.newLine();
    _builder.append("    \t");
    _builder.append("}");
    _builder.newLine();
    _builder.append("    \t");
    _builder.append("if (this.actionParam.language) {");
    _builder.newLine();
    _builder.append("    \t\t");
    _builder.append("this.actionData.language = this.actionParam.language;");
    _builder.newLine();
    _builder.append("    \t");
    _builder.append("}");
    _builder.newLine();
    _builder.append("    \t");
    _builder.append("// bind action parameters to action data");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("}");
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("    \t\t");
    _builder.append("localStorage.username = this.actionParam.username;");
    _builder.newLine();
    _builder.append("    \t");
    _builder.append("}");
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("    \t\t");
    _builder.append("localStorage.password = this.actionParam.password;");
    _builder.newLine();
    _builder.append("    \t");
    _builder.append("}");
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("    \t\t");
    _builder.append("localStorage.schema = this.actionParam.schema;");
    _builder.newLine();
    _builder.append("    \t");
    _builder.append("}");
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("    \t\t");
    _builder.append("localStorage.role = this.actionParam.role;");
    _builder.newLine();
    _builder.append("    \t");
    _builder.append("}");
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("    \t\t");
    _builder.append("localStorage.language = this.actionParam.language;");
    _builder.newLine();
    _builder.append("    \t");
    _builder.append("}");
    _builder.newLine();
  ...
  public CharSequence generateCommand() {
    ...
    _builder.newLine();
    _builder.append("                ");
    _builder.append("var timelineCommand = ACEController.getCommandByUuid(this.commandParam.uuid);");
    _builder.newLine();
    _builder.append("                ");
    ...
    _builder.newLine();
    _builder.append("        ");
    _builder.append("queryParams = this.addSchemaToQueryParams(queryParams);");
    _builder.newLine();
    _builder.append("        ");
    _builder.append("return new Promise((resolve, reject) => {");
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("                ");
    _builder.append("username: this.usernameString(),");
    _builder.newLine();
    _builder.append("                ");
    _builder.append("password: this.commandParam.password,");
    _builder.newLine();
    _builder.append("                ");
    ...
    _builder.newLine();
    _builder.append("                    ");
    _builder.append("if (jqxhr.status === 401) {");
    _builder.newLine();
    _builder.append("                        ");
    _builder.append("reject(this.httpUnauthorized);");
    _builder.newLine();
    _builder.append("                    ");
    _builder.append("} else {");
    _builder.newLine();
    _builder.append("                        ");
    _builder.append("reject(this.httpServerError);");
    _builder.newLine();
    _builder.append("                    ");
    _builder.append("}");
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("        ");
    _builder.append("data = this.addSchemaToData(data);");
    _builder.newLine();
    _builder.append("        ");
    _builder.append("return new Promise((resolve, reject) => {");
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("    ");
    _builder.append("addSchemaToQueryParams(queryParams) {");
    _builder.newLine();
    _builder.append("        ");
    _builder.append("if (!queryParams) {");
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("        ");
    _builder.append("if (this.commandParam.schema) {");
    _builder.newLine();
    _builder.append("            ");
    _builder.append("queryParams.push({");
    _builder.newLine();
    _builder.append("                ");
    _builder.append("key: \"schema\",");
    _builder.newLine();
    _builder.append("                ");
    _builder.append("value: this.commandParam.schema");
    _builder.newLine();
    _builder.append("            ");
    _builder.append("});");
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("    ");
    _builder.append("addSchemaToData(data) {");
    _builder.newLine();
    _builder.append("        ");
    _builder.append("if (!data) {");
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("            ");
    _builder.append("data.schema = this.commandParam.schema;");
    _builder.newLine();
    _builder.append("        ");
    _builder.append("}");
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("    ");
    _builder.append("usernameString() {");
    _builder.newLine();
    _builder.append("        ");
    _builder.append("var username = undefined;");
    _builder.newLine();
    _builder.append("        ");
    _builder.append("if (this.commandParam.schema) {");
    _builder.newLine();
    _builder.append("            ");
    _builder.append("username = this.commandParam.schema;");
    _builder.newLine();
    _builder.append("            ");
    _builder.append("if (this.commandParam.username) {");
    _builder.newLine();
    _builder.append("                ");
    _builder.append("username += \"_\";");
    _builder.newLine();
    _builder.append("            ");
    _builder.append("}");
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("            ");
    _builder.append("username += this.commandParam.username;");
    _builder.newLine();
    _builder.append("        ");
    _builder.append("}");
    _builder.newLine();
  ...
  public CharSequence generateACEController() {
    ...
    _builder.newLine();
    _builder.append("                ");
    _builder.append("if (ACEController.timeLine.length > 50) {");
    _builder.newLine();
    _builder.append("                    ");
