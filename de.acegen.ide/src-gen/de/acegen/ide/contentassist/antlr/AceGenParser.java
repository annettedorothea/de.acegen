...
public class AceGenParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, AceGenGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getClientModelAttributeAccess().getAlternatives_6(), "rule__ClientModelAttribute__Alternatives_6");
			...
			builder.put(grammarAccess.getClientTypeAccess().getAlternatives(), "rule__ClientType__Alternatives");
			...
			builder.put(grammarAccess.getHttpClientAceAccess().getGroup_3_2(), "rule__HttpClientAce__Group_3_2__0");
			builder.put(grammarAccess.getHttpClientAceAccess().getGroup_4(), "rule__HttpClientAce__Group_4__0");
			builder.put(grammarAccess.getHttpClientAceAccess().getGroup_4_3(), "rule__HttpClientAce__Group_4_3__0");
			builder.put(grammarAccess.getHttpClientAceAccess().getGroup_5(), "rule__HttpClientAce__Group_5__0");
			builder.put(grammarAccess.getHttpClientAceAccess().getGroup_6(), "rule__HttpClientAce__Group_6__0");
			builder.put(grammarAccess.getHttpClientAceAccess().getGroup_6_3(), "rule__HttpClientAce__Group_6_3__0");
			...
			builder.put(grammarAccess.getClientModelAttributeAccess().getGroup(), "rule__ClientModelAttribute__Group__0");
			builder.put(grammarAccess.getClientModelAccess().getGroup(), "rule__ClientModel__Group__0");
			builder.put(grammarAccess.getClientModelAccess().getGroup_1(), "rule__ClientModel__Group_1__0");
			builder.put(grammarAccess.getClientModelAccess().getGroup_1_2(), "rule__ClientModel__Group_1_2__0");
			builder.put(grammarAccess.getClientModelAccess().getGroup_2(), "rule__ClientModel__Group_2__0");
			...
			builder.put(grammarAccess.getHttpClientAccess().getModelsAssignment_4_1(), "rule__HttpClient__ModelsAssignment_4_1");
			...
			builder.put(grammarAccess.getHttpClientAceAccess().getModelAssignment_2_1(), "rule__HttpClientAce__ModelAssignment_2_1");
			builder.put(grammarAccess.getHttpClientAceAccess().getInputAssignment_3_1(), "rule__HttpClientAce__InputAssignment_3_1");
			builder.put(grammarAccess.getHttpClientAceAccess().getInputAssignment_3_2_1(), "rule__HttpClientAce__InputAssignment_3_2_1");
			builder.put(grammarAccess.getHttpClientAceAccess().getRefsAssignment_4_2(), "rule__HttpClientAce__RefsAssignment_4_2");
			builder.put(grammarAccess.getHttpClientAceAccess().getRefsAssignment_4_3_1(), "rule__HttpClientAce__RefsAssignment_4_3_1");
			builder.put(grammarAccess.getHttpClientAceAccess().getServerCallAssignment_5_1(), "rule__HttpClientAce__ServerCallAssignment_5_1");
			builder.put(grammarAccess.getHttpClientAceAccess().getLoadingIndicatorsAssignment_6_2(), "rule__HttpClientAce__LoadingIndicatorsAssignment_6_2");
			builder.put(grammarAccess.getHttpClientAceAccess().getLoadingIndicatorsAssignment_6_3_1(), "rule__HttpClientAce__LoadingIndicatorsAssignment_6_3_1");
			builder.put(grammarAccess.getHttpClientAceAccess().getOutcomesAssignment_7(), "rule__HttpClientAce__OutcomesAssignment_7");
			...
			builder.put(grammarAccess.getClientAttributeAccess().getExclusiveViewAssignment_3(), "rule__ClientAttribute__ExclusiveViewAssignment_3");
			...
			builder.put(grammarAccess.getClientModelAttributeAccess().getNotNullAssignment_0(), "rule__ClientModelAttribute__NotNullAssignment_0");
			builder.put(grammarAccess.getClientModelAttributeAccess().getListAssignment_1(), "rule__ClientModelAttribute__ListAssignment_1");
			builder.put(grammarAccess.getClientModelAttributeAccess().getNoComponentAssignment_2(), "rule__ClientModelAttribute__NoComponentAssignment_2");
			builder.put(grammarAccess.getClientModelAttributeAccess().getTreeAssignment_3(), "rule__ClientModelAttribute__TreeAssignment_3");
			builder.put(grammarAccess.getClientModelAttributeAccess().getExclusiveViewAssignment_4(), "rule__ClientModelAttribute__ExclusiveViewAssignment_4");
			builder.put(grammarAccess.getClientModelAttributeAccess().getListIdAssignment_5(), "rule__ClientModelAttribute__ListIdAssignment_5");
			builder.put(grammarAccess.getClientModelAttributeAccess().getTypeAssignment_6_0(), "rule__ClientModelAttribute__TypeAssignment_6_0");
			builder.put(grammarAccess.getClientModelAttributeAccess().getModelAssignment_6_1(), "rule__ClientModelAttribute__ModelAssignment_6_1");
			builder.put(grammarAccess.getClientModelAttributeAccess().getNameAssignment_7(), "rule__ClientModelAttribute__NameAssignment_7");
			builder.put(grammarAccess.getClientModelAttributeAccess().getLocationAssignment_8(), "rule__ClientModelAttribute__LocationAssignment_8");
			builder.put(grammarAccess.getClientModelAttributeAccess().getStorageAssignment_9(), "rule__ClientModelAttribute__StorageAssignment_9");
			builder.put(grammarAccess.getClientModelAttributeAccess().getFromParentAssignment_10(), "rule__ClientModelAttribute__FromParentAssignment_10");
			builder.put(grammarAccess.getClientModelAccess().getNameAssignment_0(), "rule__ClientModel__NameAssignment_0");
			builder.put(grammarAccess.getClientModelAccess().getSuperModelsAssignment_1_1(), "rule__ClientModel__SuperModelsAssignment_1_1");
			builder.put(grammarAccess.getClientModelAccess().getSuperModelsAssignment_1_2_1(), "rule__ClientModel__SuperModelsAssignment_1_2_1");
			builder.put(grammarAccess.getClientModelAccess().getAttributesAssignment_2_1(), "rule__ClientModel__AttributesAssignment_2_1");
			...
			builder.put(grammarAccess.getHttpServerViewAccess().getQueuedAssignment_0(), "rule__HttpServerView__QueuedAssignment_0");
