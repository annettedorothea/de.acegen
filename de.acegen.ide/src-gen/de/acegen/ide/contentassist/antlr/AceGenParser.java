...
public class AceGenParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, AceGenGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getHttpClientAccess().getGroup_2_3(), "rule__HttpClient__Group_2_3__0");
			...
			builder.put(grammarAccess.getHttpClientAccess().getFunctionsAssignment_2_3_1(), "rule__HttpClient__FunctionsAssignment_2_3_1");
			...
			builder.put(grammarAccess.getFunctionAccess().getStateElementAssignment_1_1(), "rule__Function__StateElementAssignment_1_1");
			...
			builder.put(grammarAccess.getHttpClientOutcomeAccess().getFunctionsAssignment_2_2(), "rule__HttpClientOutcome__FunctionsAssignment_2_2");
