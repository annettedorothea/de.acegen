...
public class AceGenParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, AceGenGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getNonDeterministicValueAccess().getGroup(), "rule__NonDeterministicValue__Group__0");
			builder.put(grammarAccess.getNonDeterministicValueAccess().getGroup_2(), "rule__NonDeterministicValue__Group_2__0");
			builder.put(grammarAccess.getNonDeterministicValueAccess().getGroup_2_2(), "rule__NonDeterministicValue__Group_2_2__0");
			builder.put(grammarAccess.getNonDeterministicValueAccess().getGroup_2_3(), "rule__NonDeterministicValue__Group_2_3__0");
			builder.put(grammarAccess.getNonDeterministicValueAccess().getGroup_2_4(), "rule__NonDeterministicValue__Group_2_4__0");
			...
			builder.put(grammarAccess.getClientWhenBlockAccess().getNonDeterministicValuesAssignment_2_1(), "rule__ClientWhenBlock__NonDeterministicValuesAssignment_2_1");
			builder.put(grammarAccess.getClientWhenBlockAccess().getNonDeterministicValuesAssignment_2_2_1(), "rule__ClientWhenBlock__NonDeterministicValuesAssignment_2_2_1");
			builder.put(grammarAccess.getNonDeterministicValueAccess().getUuidAssignment_2_1(), "rule__NonDeterministicValue__UuidAssignment_2_1");
			builder.put(grammarAccess.getNonDeterministicValueAccess().getClientSystemTimeAssignment_2_2_1(), "rule__NonDeterministicValue__ClientSystemTimeAssignment_2_2_1");
			builder.put(grammarAccess.getNonDeterministicValueAccess().getServerSystemTimeAssignment_2_3_1(), "rule__NonDeterministicValue__ServerSystemTimeAssignment_2_3_1");
			builder.put(grammarAccess.getNonDeterministicValueAccess().getAttributeAssignment_2_4_1(), "rule__NonDeterministicValue__AttributeAssignment_2_4_1");
			builder.put(grammarAccess.getNonDeterministicValueAccess().getValueAssignment_2_4_3(), "rule__NonDeterministicValue__ValueAssignment_2_4_3");
			...
			builder.put(grammarAccess.getAttributeAccess().getNonDeterministicAssignment_7(), "rule__Attribute__NonDeterministicAssignment_7");
