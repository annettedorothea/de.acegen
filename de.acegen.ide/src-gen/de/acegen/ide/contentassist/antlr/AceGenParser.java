...
public class AceGenParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, AceGenGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getHttpServerOutcomeAccess().getGroup_3(), "rule__HttpServerOutcome__Group_3__0");
			...
			builder.put(grammarAccess.getHttpServerOutcomeAccess().getAceOperationsAssignment_3_2(), "rule__HttpServerOutcome__AceOperationsAssignment_3_2");
