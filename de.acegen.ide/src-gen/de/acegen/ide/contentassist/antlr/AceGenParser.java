...
public class AceGenParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, AceGenGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getScenarioEventAccess().getGroup(), "rule__ScenarioEvent__Group__0");
			builder.put(grammarAccess.getVerificationAccess().getGroup(), "rule__Verification__Group__0");
			builder.put(grammarAccess.getVerificationAccess().getGroup_3(), "rule__Verification__Group_3__0");
			...
			builder.put(grammarAccess.getScenarioAccess().getEventsAssignment_1_1(), "rule__Scenario__EventsAssignment_1_1");
			builder.put(grammarAccess.getScenarioAccess().getActionAssignment_3(), "rule__Scenario__ActionAssignment_3");
			builder.put(grammarAccess.getScenarioAccess().getDataDefinitionAssignment_4(), "rule__Scenario__DataDefinitionAssignment_4");
			builder.put(grammarAccess.getScenarioAccess().getAuthorizationAssignment_5(), "rule__Scenario__AuthorizationAssignment_5");
			builder.put(grammarAccess.getScenarioAccess().getStatusCodeAssignment_7(), "rule__Scenario__StatusCodeAssignment_7");
			builder.put(grammarAccess.getScenarioAccess().getResponseAssignment_8_1(), "rule__Scenario__ResponseAssignment_8_1");
			builder.put(grammarAccess.getScenarioAccess().getVerificationsAssignment_9(), "rule__Scenario__VerificationsAssignment_9");
			...
			builder.put(grammarAccess.getScenarioEventAccess().getOutcomeAssignment_0(), "rule__ScenarioEvent__OutcomeAssignment_0");
			builder.put(grammarAccess.getScenarioEventAccess().getDataDefinitionAssignment_1(), "rule__ScenarioEvent__DataDefinitionAssignment_1");
			builder.put(grammarAccess.getVerificationAccess().getActionAssignment_0(), "rule__Verification__ActionAssignment_0");
			builder.put(grammarAccess.getVerificationAccess().getDataDefinitionAssignment_1(), "rule__Verification__DataDefinitionAssignment_1");
			builder.put(grammarAccess.getVerificationAccess().getAuthorizationAssignment_2(), "rule__Verification__AuthorizationAssignment_2");
			builder.put(grammarAccess.getVerificationAccess().getResponseAssignment_3_1(), "rule__Verification__ResponseAssignment_3_1");
