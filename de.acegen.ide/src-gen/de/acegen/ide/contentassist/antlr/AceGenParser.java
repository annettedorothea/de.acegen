...
public class AceGenParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, AceGenGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getHttpServerAccess().getLanguageAlternatives_0_0(), "rule__HttpServer__LanguageAlternatives_0_0");
			builder.put(grammarAccess.getHttpServerAccess().getTypeAlternatives_1_0(), "rule__HttpServer__TypeAlternatives_1_0");
