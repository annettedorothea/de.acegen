...
public class AceGenParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, AceGenGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getClientAttributeAccess().getGroup_8(), "rule__ClientAttribute__Group_8__0");
			builder.put(grammarAccess.getClientAttributeAccess().getGroup_8_2(), "rule__ClientAttribute__Group_8_2__0");
			builder.put(grammarAccess.getClientAttributeAccess().getGroup_8_3(), "rule__ClientAttribute__Group_8_3__0");
			...
			builder.put(grammarAccess.getClientAttributeAccess().getGroupAssignment_2(), "rule__ClientAttribute__GroupAssignment_2");
			builder.put(grammarAccess.getClientAttributeAccess().getListIdAssignment_3(), "rule__ClientAttribute__ListIdAssignment_3");
			builder.put(grammarAccess.getClientAttributeAccess().getNameAssignment_4(), "rule__ClientAttribute__NameAssignment_4");
			builder.put(grammarAccess.getClientAttributeAccess().getLocationAssignment_5(), "rule__ClientAttribute__LocationAssignment_5");
			builder.put(grammarAccess.getClientAttributeAccess().getStorageAssignment_6(), "rule__ClientAttribute__StorageAssignment_6");
			builder.put(grammarAccess.getClientAttributeAccess().getUiElementAssignment_7(), "rule__ClientAttribute__UiElementAssignment_7");
			builder.put(grammarAccess.getClientAttributeAccess().getAttributesAssignment_8_1(), "rule__ClientAttribute__AttributesAssignment_8_1");
			builder.put(grammarAccess.getClientAttributeAccess().getOptionsAssignment_8_2_1(), "rule__ClientAttribute__OptionsAssignment_8_2_1");
			builder.put(grammarAccess.getClientAttributeAccess().getActionsAssignment_8_3_2(), "rule__ClientAttribute__ActionsAssignment_8_3_2");
