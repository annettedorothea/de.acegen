...
public class AceGenParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, AceGenGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getHttpClientStateElementAccess().getGroup_3(), "rule__HttpClientStateElement__Group_3__0");
			builder.put(grammarAccess.getHttpClientStateElementAccess().getGroup_7(), "rule__HttpClientStateElement__Group_7__0");
			builder.put(grammarAccess.getHttpClientStateElementAccess().getGroup_7_1(), "rule__HttpClientStateElement__Group_7_1__0");
			...
			builder.put(grammarAccess.getClientWhenBlockAccess().getGroup_3(), "rule__ClientWhenBlock__Group_3__0");
			builder.put(grammarAccess.getClientWhenBlockAccess().getGroup_5(), "rule__ClientWhenBlock__Group_5__0");
			...
			builder.put(grammarAccess.getTriggeredActionAccess().getGroup_3(), "rule__TriggeredAction__Group_3__0");
			...
			builder.put(grammarAccess.getHttpClientAceAccess().getStateElementsAssignment_3_1(), "rule__HttpClientAce__StateElementsAssignment_3_1");
			builder.put(grammarAccess.getHttpClientAceAccess().getStateElementsAssignment_3_2_1(), "rule__HttpClientAce__StateElementsAssignment_3_2_1");
			...
			builder.put(grammarAccess.getHttpClientStateElementAccess().getNotNullAssignment_0(), "rule__HttpClientStateElement__NotNullAssignment_0");
			builder.put(grammarAccess.getHttpClientStateElementAccess().getTypeAssignment_1(), "rule__HttpClientStateElement__TypeAssignment_1");
			builder.put(grammarAccess.getHttpClientStateElementAccess().getNameAssignment_2(), "rule__HttpClientStateElement__NameAssignment_2");
			builder.put(grammarAccess.getHttpClientStateElementAccess().getModelAssignment_3_1(), "rule__HttpClientStateElement__ModelAssignment_3_1");
			builder.put(grammarAccess.getHttpClientStateElementAccess().getListAssignment_4(), "rule__HttpClientStateElement__ListAssignment_4");
			builder.put(grammarAccess.getHttpClientStateElementAccess().getHashAssignment_5(), "rule__HttpClientStateElement__HashAssignment_5");
			builder.put(grammarAccess.getHttpClientStateElementAccess().getStorageAssignment_6(), "rule__HttpClientStateElement__StorageAssignment_6");
			builder.put(grammarAccess.getHttpClientStateElementAccess().getTypesAssignment_7_0(), "rule__HttpClientStateElement__TypesAssignment_7_0");
			builder.put(grammarAccess.getHttpClientStateElementAccess().getTypesAssignment_7_1_1(), "rule__HttpClientStateElement__TypesAssignment_7_1_1");
			builder.put(grammarAccess.getHttpClientTypeDefinitionAccess().getElementsAssignment_1(), "rule__HttpClientTypeDefinition__ElementsAssignment_1");
			builder.put(grammarAccess.getHttpClientTypeDefinitionAccess().getElementsAssignment_2(), "rule__HttpClientTypeDefinition__ElementsAssignment_2");
			...
			builder.put(grammarAccess.getClientWhenBlockAccess().getInputValuesAssignment_2(), "rule__ClientWhenBlock__InputValuesAssignment_2");
			builder.put(grammarAccess.getClientWhenBlockAccess().getInputValuesAssignment_3_1(), "rule__ClientWhenBlock__InputValuesAssignment_3_1");
			builder.put(grammarAccess.getClientWhenBlockAccess().getStatusCodeAssignment_5_2(), "rule__ClientWhenBlock__StatusCodeAssignment_5_2");
			builder.put(grammarAccess.getClientWhenBlockAccess().getResponseAssignment_5_3(), "rule__ClientWhenBlock__ResponseAssignment_5_3");
			...
			builder.put(grammarAccess.getClientThenBlockAccess().getTriggeredActionAssignment_2_1(), "rule__ClientThenBlock__TriggeredActionAssignment_2_1");
			builder.put(grammarAccess.getTriggeredActionAccess().getHttpClientAceAssignment_0(), "rule__TriggeredAction__HttpClientAceAssignment_0");
			builder.put(grammarAccess.getTriggeredActionAccess().getInputValuesAssignment_2(), "rule__TriggeredAction__InputValuesAssignment_2");
			builder.put(grammarAccess.getTriggeredActionAccess().getInputValuesAssignment_3_1(), "rule__TriggeredAction__InputValuesAssignment_3_1");
